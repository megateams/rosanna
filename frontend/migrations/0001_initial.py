# Generated by Django 3.2.17 on 2023-07-31 19:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classlevel', models.CharField(blank=True, max_length=100, verbose_name='Classlevel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('studentclass', models.CharField(blank=True, choices=[('baby', 'baby'), ('middle', 'middle'), ('top', 'top'), ('P.1', 'P.1'), ('P.2', 'P.2'), ('P.3', 'P.3'), ('P.4', 'P.4'), ('P.5', 'P.5'), ('P.6', 'P.6'), ('P.7', 'P.7')], default=None, max_length=10, verbose_name='Class choices')),

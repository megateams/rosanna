...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('paymentid', models.CharField(max_length=10, primary_key=True, serialize=False, verbose_name='Payment id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paymentmethod', models.CharField(max_length=25, verbose_name='Payment Method')),
                ('bankaccnum', models.CharField(max_length=25, verbose_name='bankaccnum')),
                ('teacherid', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='frontend.teachers')),
            ],
        ),
        migrations.CreateModel(
            name='Staffpayments',

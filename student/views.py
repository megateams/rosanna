...
def my_results(request, std_number, class_id):
    feesdetails = Fees.objects.get(stdnumber = std_number)
    if feesdetails.balance == 0:
        student = Student.objects.get(stdnumber=std_number)
        ...
        return render(request, 'student/my_results.html', {'noresults' : 'No Results due to incomplete Fees.'})
